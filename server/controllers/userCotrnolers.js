                ...
                if (resi == "no") {
                    ...
                    return res.status(200).json({
                        ...
                        "data": [
                            ...
                            {
                                "token": tokens.encode({ isadmin, firstname, secondname, id, email, phone, vendor, country, age }),
                                "details": {
                                    username: secondname,
                                    name: firstname,
                                    id: id,
    ...
    getAllUsers(req, res) {
        account.allUsers(req.body)
            .then(results => {
                let displayResults = []
                results.forEach(n => {
                    let { id, firstname, email, phone, picture, vendor, age, secondname, countrycode, country, gender, date } = n
                    let registeredDate = date
                    displayResults.push({ id, firstname, secondname, email, phone, picture, vendor, age, gender, registeredDate, country, countrycode })
                })
                return res.status(200).json({
                    "status": 200,
                    "data": displayResults
